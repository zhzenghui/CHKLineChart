...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/zhzenghui/CHKLineChart"
  s.screenshots  = "https://github.com/zhzenghui/CHKLineChart/blob/master/demo.png?raw=true"

  s.license      = "MIT"
  s.author       = { "Chance" => "zhiquan911@qq.com" }
  s.platform     = :ios, "8.0"
  s.ios.deployment_target = '8.0'
  s.source       = { :git => "https://github.com/zhzenghui/CHKLineChart.git", :tag => s.version}
